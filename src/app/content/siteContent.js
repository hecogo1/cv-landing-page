export const siteContent = {
  ...
  timeline: {
    ...
    items: [
      'Age 12+: fixing computers and solving technical problems',
      'TAFAD: rediscovering motivation through practical learning',
      'Psychology degree: research, statistics, psychometrics, R',
      'Research collaborations: intelligence, museums, simulation',
      'Master’s in research methodology and psychometrics',
      'Australia: one year to improve English before COVID',
      'Psychometric testing company',
      'Invisalign: technology, clients, and corporate reality',
      'Master’s in Big Data and Data Science',
      'Days: first practical step into data',
      'CaixaBank: SQL at scale, automation, quality, enablement, migration',
    ],
  },
  strengths: {
